...
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Alan', 'Won', '(516)992-9423', 'ahwon@icloud.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Amelie', 'Mosley', '(667)303-9303', 'meinkej@yahoo.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Andres',	'Ramon', '(413)785-5626', 'andale@icloud.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Arturo',	'Cisneros', '(347)563-4789', 'munson@live.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Charlize', 'Perez', '(289)572-1200',	'jaffe...@verizon.net');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Dahlia', 'Arellano', '(618)691-4399', 'jtorkbob@comcast.net');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Dan',	'Zigi',	'(256)931-9696', 'danzigis,m@icloud.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Drake', 'Rebs',  '(219)683-8767', 'wkrebs@sbcglobal.net');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Esperanza', 'Knapp', '(810)234-9251',	'pgottsch@mac.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Fisher', 'Here', '(434)299-8652', 'a~dhere@aol.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Frederic', 'Lee', '(205)365-8292',	'frederic@sbcglobal.net');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Gavin', 'Obrien', '(786)441-2729', 'gavinls@sbcglobal.net');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Giovanny', 'Atkinson', '(401)433-3114', 'spa.dkins@att.net');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Howard', 'Carrillo', '(289)672-8870', 'rddesign@live.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('James', 'Randolph', '(507)623-3577', 'sopwith@aol.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Jamie', 'Martinez', '(617)889-8674', 'intlprog@hotmail.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Jaslene', 'Whitaker', '(352)434-1651', 'bonmots@comcast.net');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Jayden', 'Chi', '(305)674-4548', 'fukuchi@gmail.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Jesse', 'Hahn', '(231)823-9734', 'jesse@sbcglobal.net');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Jesse', 'Hahn', '(231)823-9734', 'jesse@sbcglobal.net');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Joel',	'Schaefer', '(336)877-9176', 'joelw@yahoo.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Joel', 'Schaefer', '(336)877-9176', 'joelw@yahoo.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Jordyn', 'Mullen', '(385)207-5077', 'errxn@sbcglobal.net');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Joyce', 'Frank', '(319)635-4374', 'bockelboy@me.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Korbin', 'Pereinar', '(415)572-8494', 'pereinar@sbcglobal.net');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Kyan',	'Harper', '(209)828-3279', 'webteam@msn.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Louise', 'Barber', '(336)929-8671', 'louise@me.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Lucille',	'Malattia', '(608)380-4822', 'malattia@yahoo.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Marcel', 'Sloan', '(616)889-7721', 'marslo@aol.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Marshall', 'Landry', '(551)587-7297', 'reziac@gmail.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Meadow', 'Berger', '(670)233-6224', 'syrinx@optonline.net');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Murdoc', 'Wilkinson', '(806)774-7884', 'murdocj@optonline.net');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Nayeli', 'Juarez', '(657)378-3335', 'storerm@sbcglobal.net');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Nayomi', 'Dawson', '(276)335-6240', 'naoya@msn.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Nelson', 'Silva', '(303)961-5760', 'dgatwood@optonline.net');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Olive', 'Lang', '(618)472-3603', 'zilla@optonline.net');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Owen', 'Stein', '(769)355-5422', 'lstein@aol.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Paris', 'Mann', '(336)283-4614', 'bachmann@hotmail.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Rafael', 'Viegas', '(214)969-3080', 'fviegas@mac.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Reagan', 'Sweeney', '(216)271-8398', 'miyop@verizon.net');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Rhianna',	'Armstrong', '(575)628-5858', 'wojciech@outlook.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Rob', 'Shaw', '(615)221-5554', 'mrobshaw@outlook.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Rodrigo', 'Cuevas', '(308)204-9038', 'bcevc@icloud.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Roger', 'Brown', '(323)298-3567', 'rogerspl@mac.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Santiago', 'Riddle', '(425)423-4138', 'harryh@icloud.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Santino', 'Cabrera', '(747)900-6516', 'trieuvan@aol.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Sara', 'Palmer', '(217)657-9901', 'lpalmer@icloud.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Shaniya',	'Brown', '(208)255-2382', 'mbrown@live.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Whitney', 'Shelton', '(334)201-6824',	'presoff@msn.com');
INSERT INTO contacts (firstName, lastName, phoneNumber, email) VALUES ('Zaiden', 'Duran', '(618)231-7450', 'cderoove@gmail.comm');
